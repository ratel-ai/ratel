...
describe("TaskCorrectness (LLM judge path)", () => {
  ...
  it("shows 100% coverage when all slots satisfied", async () => {
    ...
    const output = makeOutput(
      ...
      {
        toolCalls: [
          { type: "tool-call" as const, toolCallId: "c1", toolName: "searchEmployees", input: {} },
          { type: "tool-call" as const, toolCallId: "c2", toolName: "getSalary", input: {} },
        ],
      },
    );
    await TaskCorrectness(output);
        ...
        toolCalls: [
          {
            ...
            toolCallId: "call-1",
            toolName: "bookRoom",
            input: { roomId: "A1", date: "2026-03-01" },
          },
        ],
      },
    );
        ...
        toolCalls: [
          {
            ...
            toolCallId: "call-1",
            toolName: "createNDA",
            input: { scope: "Shared product roadmap" },
          },
        ],
      },
    );
