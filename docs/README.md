...
Amend in place for small drift; write a superseding ADR for real decision reversals; compact periodically — git history is the archive (the set was re-founded 2026-07, compacting 21 records into 9; provenance notes in each record map the old numbers).
